    ...
    try {
        ...
        <body>
            <div class='header'>
                <div>
                    <h2>Mundo Pink</h2>
                    <p>📍 Dirección: Cra 9 # 3sur-16, Gudalajara de Buga</p>
                    <p>📞 Teléfono: +57 3173802770</p>
                    <p>📧 Email: carvajalkatherine084@gmail.com </p>
                </div>
            </div>
            <hr>
        ...
        $cabeceras .= 'From: MUNDO PINK <contacto@mundopink.com>' . "\r\n";
